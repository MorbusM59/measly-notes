...
function sanitizeMenu(input: Partial<PersistedMenuState> | undefined): PersistedMenuState {
  ...
  return {
    ...
    wheelStepRows: sanitizeOptionalNumber(input?.wheelStepRows),
    wheelStepLines: sanitizeOptionalNumber(input?.wheelStepLines),
    ...
    noteSizeThresholdBlocks: sanitizeOptionalNumber(input?.noteSizeThresholdBlocks),
